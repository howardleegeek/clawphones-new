...
- **Connected wallet** — Get address from UniversalClaw app
...
- **Secrets blocklist** — `config.json`, `config.yaml`, `universalclaw.db` blocked from `read` tool (with symlink resolution) and `js_eval` fs access (proxied `fs`/`fs.promises` modules)
...
- **GitHub:** https://github.com/sepivip/UniversalClaw
- **Website:** https://universalclaw.xyz/
- **X/Twitter:** https://x.com/UniversalClaw
- **Telegram:** https://t.me/universalclaw
...
| 2026-02-25 | Feat: add official UniversalClaw socials to agent identity (BAT-263) | #185 |
...
| 2026-02-25 | Fix: replace universalclaw.dev with universalclaw.xyz everywhere | direct |
