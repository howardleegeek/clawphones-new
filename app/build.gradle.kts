...
android {
    namespace = "ai.clawphones.agent"
    compileSdk = 35

    defaultConfig {
        applicationId = "ai.clawphones.agent"
        minSdk = 34
        targetSdk = 35
        versionCode = 6
        versionName = "1.4.1"
    ...
    signingConfigs {
        create("dappStore") {
            val ksPath = signingProp("UNIVERSALCLAW_KEYSTORE_PATH", "UNIVERSALCLAW_KEYSTORE_PATH")
            if (ksPath != null) {
                storeFile = file(ksPath)
                storePassword = signingProp("UNIVERSALCLAW_STORE_PASSWORD", "UNIVERSALCLAW_STORE_PASSWORD")
                keyAlias = signingProp("UNIVERSALCLAW_KEY_ALIAS", "UNIVERSALCLAW_KEY_ALIAS")
                keyPassword = signingProp("UNIVERSALCLAW_KEY_PASSWORD", "UNIVERSALCLAW_KEY_PASSWORD")
            }
        }
        create("googlePlay") {
