...
const char *ADBTAG = "CLAWPHONES-NODE";
...
// Package path: ai.clawphones.agent.service.NodeBridge
extern "C" jint JNICALL
Java_ai_clawphones_agent_service_NodeBridge_startNodeWithArguments(
        JNIEnv *env,
        jobject /* this */,
