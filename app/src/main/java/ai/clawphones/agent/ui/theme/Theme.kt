package ai.clawphones.agent.ui.theme
...
// ============================================================================
// DARKOPS THEME — ClawPhones's single theme
// ============================================================================
...
val DarkOpsThemeColors = ThemeColors(
    ...
    surfaceHighlight = Color(0xFF353535),
    cardBorder = Color(0x40505050),

    // 品牌主色 — 金色
    primary = Color(0xFFE8A853),       // Gold
    primaryDim = Color(0xFFC08A3A),
    primaryGlow = Color(0x33E8A853),
    ...
    textPrimary = Color(0xFFF5F0E6),   // Cream
    textSecondary = Color(0xFF9CA3AF),
    textDim = Color(0xFF9CA3AF),
    textInteractive = Color(0xB3F5F0E6),   // 70% cream

    borderSubtle = Color(0xFF505050),  // warmer gray
...
// ============================================================================
// ClawPhonesColors — Global color accessor (DarkOps only)
// ============================================================================
object ClawPhonesColors {
...
@Composable
fun ClawPhonesTheme(content: @Composable () -> Unit) {
    MaterialTheme(
