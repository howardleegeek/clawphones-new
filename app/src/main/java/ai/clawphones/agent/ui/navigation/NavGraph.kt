package ai.clawphones.agent.ui.navigation
...
import ai.clawphones.agent.ui.dashboard.DashboardScreen
import ai.clawphones.agent.ui.logs.LogsScreen
import ai.clawphones.agent.ui.settings.SettingsScreen
import ai.clawphones.agent.ui.setup.SetupScreen
import ai.clawphones.agent.ui.skills.SkillsScreen
import ai.clawphones.agent.ui.system.SystemScreen
    ...
    Scaffold(
                        ...
                        bottomNavItems.forEach { item ->
                            ...
                            NavigationBarItem(
                                ...
                                colors = NavigationBarItemDefaults.colors(
                                    selectedIconColor = ClawPhonesColors.Primary,
                                    selectedTextColor = ClawPhonesColors.Primary,
                                    unselectedIconColor = ClawPhonesColors.TextDim,
                                    unselectedTextColor = ClawPhonesColors.TextDim,
        ...
        NavHost(
            ...
            composable<AnthropicConfigRoute> {
                ai.clawphones.agent.ui.settings.AnthropicConfigScreen(
                    onBack = { navController.popBackStack() }
                )
            }
            composable<TelegramConfigRoute> {
                ai.clawphones.agent.ui.settings.TelegramConfigScreen(
                    onBack = { navController.popBackStack() }
                )
            }
        }
