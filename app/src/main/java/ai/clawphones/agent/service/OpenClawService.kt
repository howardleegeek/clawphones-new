package ai.clawphones.agent.service
...
import ai.clawphones.agent.MainActivity
import ai.clawphones.agent.R
import ai.clawphones.agent.ClawPhonesApplication
import ai.clawphones.agent.bridge.AndroidBridge
...
class OpenClawService : Service() {
    ...
    private fun createNotification(text: String): Notification {
        ...
        return NotificationCompat.Builder(this, ClawPhonesApplication.CHANNEL_ID)
    ...
    private fun createSetupNotification(text: String): Notification {
        ...
        return NotificationCompat.Builder(this, ClawPhonesApplication.ERROR_CHANNEL_ID)
            .setContentTitle("ClawPhones")
            .setContentText(text)
            .setSmallIcon(R.drawable.ic_notification)
            .setContentIntent(pendingIntent)
